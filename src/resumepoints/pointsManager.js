...
class ResumePoints {
  ...
  summaryScore(summary) {
    ...
    const para = count(summary, async (counter) => {
      ...
      else if (20 <= words <= 100)  summarys.push(15);
  ...
  skillsScore(softSkills, 
    ...
    if (softLength.length === 0) {
      ...
      softScore.push(5);
    } else if (softLength.length <= 6) {
      softScore.push(8);
    } else softScore.push(15);
   ...
   resumeSummary(summary) {
    ...
    const para = count(summary, async (counter) => {
      ...
      if (  words < 10)  summarys.push(0);
      else if (words <= 41)  summarys.push(5);
      else if (words <= 130)  summarys.push(25);
      else if ( words <= 150)  summarys.push(20);
